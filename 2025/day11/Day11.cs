...
public static class Day11
{
    ...
    {
        int sum = 0;
        using StringReader? sr = new(File.ReadAllText("./day11/input.txt"));
        
        List<string> input = ParseInput(sr);
        
        Console.WriteLine($"[AoC 2025 - Day 11 - Part 1] Result: {Part1(sum)}");
        Console.WriteLine($"[AoC 2025 - Day 11 - Part 2] Result: {Part2(sum)}");
    }
}